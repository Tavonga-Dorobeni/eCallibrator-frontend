<template>
  <div
    ...
    :style="{
      backgroundImage:
        'url(' + require('@/assets/images/all-img/page-bg.png') + ')',
    }"
  >
...
width="138" height="32" alt="" class="mx-auto"
            /></router-link>
          </div>
          ...
          <div class="author-bio text-center mt-10 mb-8">
          ...
          <div
            class="text-sm mx-auto w-full text-center font-normal text-slate-500 dark:text-slate-400 mt-12 uppercase"
          >
            Not you ? return
            <router-link
              to="/"
