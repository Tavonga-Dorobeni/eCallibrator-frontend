<template>
  ...
  >
    ...
    <div>
      ...
      <div class="flex space-x-3 pt-4 pb-6 items-start">
        <div class="flex-none">
        ...
        <div class="flex-1">
          ...
          <div class="relative -top-1">
            <Dropdown classMenuItems="left-0 w-fit  top-[110%] ">
              <span
                class="text-slate-500 dark:text-slate-400 text-xs flex space-x-1 items-center"
      ...
      <div
        class="border-t border-b py-4 my-6 border-slate-100 dark:border-slate-700 flex flex-wrap space-x-5"
      >
...
const image = computed(() => {
  return store.state.email.storeEmail.image;
});
const closeDetailsEmail = () => {
  store.dispatch("closeDetailsEmail");
};
</script>
