<template>
  <div>
    <button
      @click="openModal"
      class="flex items-center xl:text-sm text-lg xl:text-slate-400 text-slate-800 dark:text-slate-300 px-1 space-x-3"
    >
          ...
          <Combobox v-model="selected">
            <div class="relative">
              ...
              >
                ...
                >
                  <div
                    className="flex-0  text-slate-700 dark:text-slate-300 pr-2 text-lg"
                  >
