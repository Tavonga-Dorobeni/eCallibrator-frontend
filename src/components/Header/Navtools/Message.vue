<template>
  ...
  >
    <span
      class="relative lg:h-[32px] lg:w-[32px] lg:bg-gray-500-f7 lg:dark:bg-slate-900 dark:text-white mr-6 last:mr-0 text-slate-900 cursor-pointer rounded-full text-[20px] flex flex-col items-center justify-center"
            ...
            <div class="flex text-left">
              <div class="flex-none mr-3">
                ...
                >
                  <span
                    :class="`${
                      item.active ? 'bg-secondary-500' : 'bg-slate-500'
